  ...
  const onMutate = (e) => {
      ...
      if (e.target.files) {
          setFormData((prevState) => ({
              ...prevState,
              images: e.taget.files
          }));
      }

      // Tex/Booleans/Numbers
      if (!e.target.files) {
          setFormData((prevState) => ({
              ...prevState,
      ...
      <main>
          <form onSubmit={onSubmit}>
            ...
            <div className="formPriceDiv">
                <input className="formInputSmall" type="number" id="regularPrice" value={regularPrice} onChange={onMutate} min="50" max="75000000" required />
                {type === "rent" && (
            ...
            {offer && (
                <>
                    ...
                    <div className="formPriceDiv">
                        <input className="formInputSmall" type="number" id="discountedPrice" value={discountedPrice} onChange={onMutate} min="50" max="750000000" required />
                        {type === "rent" && (
                        <p className="formPriceText">$ / month</p>
                    )}
                    </div>
